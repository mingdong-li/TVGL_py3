...
def TVGL_PN(data, lengthOfSlice, lamb, beta, verbose = False, eps = 3e-3, epsAbs = 1e-3, epsRel = 1e-3):        
    indexOfPenalty = 5
    print('Use perturbation penalty function')
    ...
    for i in range(timestamps):
        ...
        # k_next = min(k + lengthOfSlice, numberOfTotalSamples)  # 会去调用cvxpy的min函数
